...
8:[
  ...
  {q:"El delito de omisión del deber de socorro se recoge en el:",options:["Art. 195 CP","Art. 172 CP","Art. 550 CP","Art. 263 CP"],correct:0,exp:"Art. 195 CP: no socorrer a una persona desamparada y en peligro manifiesto y grave, pudiendo hacerlo sin riesgo propio ni de tercero."},
  ...
  {q:"La legítima defensa está regulada, como causa que exime de responsabilidad criminal, en el:",options:["Art. 21 CP","Art. 22 CP","Art. 20 CP","Art. 23 CP"],correct:2,exp:"Art. 20.4 CP recoge la legítima defensa entre las causas que eximen de responsabilidad criminal."}
],
9:[
  ...
  {q:"En vías urbanas de un único carril por sentido de circulación, la velocidad máxima genérica es de:",options:["30 km/h","20 km/h","40 km/h","50 km/h"],correct:0,exp:"Desde la reforma en vigor en mayo de 2021: 20 km/h en vías de plataforma única, 30 km/h con un solo carril por sentido y 50 km/h con dos o más carriles por sentido."},
  ...
  {q:"Un conductor que obtiene por primera vez el permiso de conducción parte de un saldo inicial de:",options:["8 puntos","6 puntos","12 puntos","15 puntos"],correct:0,exp:"Parte de 8 puntos y pasa a 12 transcurridos tres años sin haber sido sancionado con pérdida de puntos."},
